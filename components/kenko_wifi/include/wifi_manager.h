...
/** 配网热点的固定地址与入口 URL，供 captive portal 的重定向使用。 */
#define KENKO_AP_IP_ADDR CONFIG_KENKO_AP_IP
#define KENKO_AP_URL "http://" CONFIG_KENKO_AP_IP "/"
 ...
 * 初始化 WiFi 子系统。
 *
 * @param sta_hostname STA 侧向 DHCP 上报的主机名，必须是合法 DNS 标签；传 NULL 表示不设置。
 */
