...
esp_err_t device_info_init(void)
{
    ...
    snprintf(s_identity.default_name, sizeof(s_identity.default_name), "%s-%s", KENKO_DEVICE_PREFIX,
    ...
    s_identity.firmware_version = KENKO_FIRMWARE_VERSION_INT;
    s_identity.firmware_name = KENKO_FIRMWARE_VERSION_NAME;
